...
export const BUCKETS: { name: string; items: Upgrade[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "routeOpt", name: "Better Rates", effect: "+$1 per delivery", baseCost: 15, costMult: 1.5, maxLevel: 40 },
      { id: "dayBonus", name: "Bulk Contracts", effect: "cash bonus for finishing a day", baseCost: 50, costMult: 1.4, maxLevel: 1000, requires: "fleet", requiresLevel: 1 },
