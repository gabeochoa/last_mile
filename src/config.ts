...
export const BUCKETS: { name: string; items: Upgrade[] }[] = [
  ...
  },
  {
    name: "ECONOMY",
    items: [
      { id: "demand", name: "Spread Flyers", effect: "more deliveries per day", baseCost: 5, costMult: 1.2, softCap: true },
  ...
  },
  {
    name: "TERRITORY",
    items: [
      { id: "expand", name: "Map Expansion", effect: "open new territory (mostly rival-held)", baseCost: 100, costMult: 1.12, maxLevel: 100, requiresAny: ["autopilot", "fleet"] },
