...
export const BUCKETS: { name: string; items: Upgrade[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "mileage", name: "Green Energy", effect: "electric vans — no more gas: save $100k per cell driven each day, per level", baseCost: 1_000_000_000, costMult: 1.5, maxLevel: 100, requiresCash: 1_000_000_000 },
...
// Green Energy -> cash saved per cell any of your vans (or you) drive: $100,000 per level.
export function mileagePay(u: Record<string, number>) {
  return (u.mileage ?? 0) * 100000;
}
