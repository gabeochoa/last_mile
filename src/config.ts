...
export const BUCKETS: { name: string; items: Upgrade[] }[] = [
  ...
  },
  {
    name: "ECONOMY",
    items: [
      { id: "demand", name: "Demand Engine", effect: "more deliveries per day", baseCost: 5, costMult: 1.2 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "buyout", name: "Buy Out Rivals", effect: "one fewer rival delivery point on the map", baseCost: 250, costMult: 1.6, maxLevel: 6 },
